...
function load(){
    ...
    products.push(new Product(4, "Lenovo Thinkpad", 88000, "Laptops"));
    products.push(new Product(5, "Logitech headphone 390", 4500, "Headphones"));
    products.push(new Product(6, "Amazon Echo", 7000, "Devices"));
    products.push(new Product(7, "HP Deskjet Printer", 15000, "Printers"));
